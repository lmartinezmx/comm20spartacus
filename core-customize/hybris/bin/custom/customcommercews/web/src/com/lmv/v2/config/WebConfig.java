 ...
 */
package com.lmv.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.lmv.constants.YcommercewebservicesConstants;
import com.lmv.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "customcommercews.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "customcommercews.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "customcommercews.oauth2.tokenUrl";

	private static final String DESC = "customcommercews.v2.description";
	private static final String TITLE = "customcommercews.v2.title";
	private static final String VERSION = "customcommercews.v2.version";
	private static final String LICENSE = "customcommercews.v2.license";
	private static final String LICENSE_URL = "customcommercews.v2.license.url";
